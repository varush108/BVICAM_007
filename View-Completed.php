...
require_once 'config.php';
		$sql = "SELECT user.name,ref_no.ref_no,request_details.visits,request_details.ref_id, request_details.status,request_details.building_address,user.name FROM request_details,user,ref_no WHERE request_details.ref_id=ref_no.id and ref_no.user_id = user.UID  AND request_details.status='Completed'" ;
...
<body class="fixed-nav top-nav">
    ...
    <div class="content-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="page-title mb-4 d-flex align-items-center">
                <div class="mr-auto">
                    <h4 class="weight500 d-inline-block pr-3 mr-3 border-right">View Status</h4>
                    ...
                    <div class="card card-shadow mb-4">
                        <div class="card-header border-0">
                            <div class="custom-title-wrap bar-success">
                                <div class="custom-title"><h2>List Of Requests</h2></div>
                            </div>
                        </div>
                        <div class="card-body">
                        ...
                        <div id="request_details" class="card-body">
                            <div class="alert alert-warning" role="alert">
                                ...
                                <hr>
								<h4 class="alert-heading">Details Of Inspector</h4>
                                <p id="InsName"></p>
	...
	function handle(ref_no)
	{
		...
		$.post("services/getRequestData.php",{ref_no : ref_no},function(response){
		...
		if(data["success"] && data["data"])
		{
			...
			$('#InsRank').html('<strong>Rank :</strong>'+data["InspectorRank"]);
			$('#InsRatings').html('<strong>Ratings :</strong>'+data["InspectorRatings"]);			
		}
		else
		{
