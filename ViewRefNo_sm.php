...
$sql="SELECT ref_no,owner_name,address from ref_no_msl";
...
<head>
    ...
    <title>View Reference Numbers</title>
    ...
    <div class="content-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="page-title mb-4 d-flex align-items-center">
                <div class="mr-auto">
                    <h4 class="weight500 d-inline-block pr-3 mr-3 border-right">Search Reference Number</h4>
					...
					<div class="card card-shadow mb-4">
                        <div class="card-header border-0">
                            <div class="custom-title-wrap bar-primary">
                                <div class="custom-title" style="font-size:20px;">List Of Reference Numbers</div>
                            </div>
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                  Checklist for Installation :<br><ul><li>Fire extinguisher</li></ul>
												  <br>
