...
{
$labelsm=[
    "l001"=>"Profile System Manager",
    "l002"=>"Edit",
    "l003"=>"Total Inspectors",
    "l004"=>"Total Requests",
    "l005"=>"Pending Requests",
    "l006"=>"Requests To Be Rescheduled"
    ];
}
else
{
$labelsm=[
    "l001"=>"प्रोफाइल सिस्टम मैनेजर",
    "l002"=>"संपादित करें",
    "l003"=>"कुल निरीक्षक",
    "l004"=>"कुल अनुरोध",
    "l005"=>"अनुरोध लंबित",
    "l006"=>"पुनर्निर्धारित करने वाले अनुरोध"
    ];
}
                        ...
                        <div class=" widget-action-link">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right vl-dropdown">
                                    <a class="dropdown-item" href="#"><?= $labelsm["l002"]; ?></a>
                                </div>
                            </div>
                        </div>
                        <!--
                        ...
                        <div class="card card-shadow mb-4">
                            <div class="card-body">
                                <div class="media d-flex align-items-center">
									...
									?>
                                        <span class="text-muted"><?= $labelsm["l003"]; ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="media d-flex align-items-center">
                                    <div class="mr-4 rounded-circle bg-purple sr-icon-box bubble-shadow-small">
                                  	...
                                  	<?php
										$sql="SELECT id from request_details";
										if($stmt = $pdo->prepare($sql))
											{
												if($stmt->execute())
												{
									...
									?>
                                        <span class="text-muted"><?= $labelsm["l004"]; ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="media d-flex align-items-center">
                                    <div class="mr-4 rounded-circle bg-danger sr-icon-box bubble-shadow-small">
                                  	...
                                  	<?php
										$sql="SELECT id from request_details where DOI is NOT NULL";
										if($stmt = $pdo->prepare($sql))
											{
												if($stmt->execute())
												{
									...
									?>
                                        <span class="text-muted"><?= $labelsm["l005"]; ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="media d-flex align-items-center">
                                    <div class="mr-4 rounded-circle bg-purple-light sr-icon-box bubble-shadow-small">
                                        <i class="icon-reload"></i>
                                                                   	...
                                                                   	<?php
										$sql="SELECT id from request_details where DOI IS NULL AND status = 'Accepted' ";
										if($stmt = $pdo->prepare($sql))
											{
												if($stmt->execute())
												{
									...
									?>
									<span class="text-muted"><?= $labelsm["l006"]; ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
